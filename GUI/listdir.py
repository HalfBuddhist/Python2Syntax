...
# coding=utf-8
"""
例19.6 GUI 文件遍历系统 （listdir.py）
这个稍高级一些的GUI 程序扩大了组建的使用范围，演员名单里新增了列表框、文本框、和滚
...
class DirList(object):
    def __init__(self, initdir=None):
        ...
        self.cwd = StringVar(self.top) #the variable of the constant in the Tk
        ...
        if initdir:
            self.cwd.set(initdir) #the variable of the constant in the Tk
            self.doLS()
    ...
    def setDirAndGo(self, ev=None):
        self.last = self.cwd.get() #the variable of the constant in the Tk
    ...
    def doLS(self, ev=None):
        ...
        dirlist.sort()
        os.chdir(tdir) #change the current dir
